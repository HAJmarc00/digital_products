...
class Payment(models.Model):
    ...
    STATUS_TRANSLATIONS = {
        ...
        STATUS_ERROR : _('Payment has encountered anerror, Our technical team will check the problem shortly'),
    ...
    package = models.ForeignKey('subscriptions.Package', verbose_name=_('%(class)s'), on_delete=models.CASCADE)
    ...
    created_time  = models.DateTimeField(_('creation time'), auto_now_add=True, null=True)
