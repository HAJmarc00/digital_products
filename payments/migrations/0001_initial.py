    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(10, 'Paid'), (30, 'User Canceled'), (31, 'Refunded:'), (20, 'Error'), (0, 'Void')], db_index=True, default=0, verbose_name='status')),
                ...
                ('consumed_code', models.PositiveIntegerField(db_index=True, null=True, verbose_name='consumed code')),
                ('created_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='creation time')),
